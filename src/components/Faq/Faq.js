      ...
      <div className="row">
        <div className="col-12">
          <div className="paragraphBox">
            <h3>Do I have to have an account to place a purchase?</h3>
            <p>
          ...
          <div className="paragraphBox">
            ...
            <p>
              Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque.
            </p>
          </div>
          <div className="paragraphBox">
            <h3>What payment options are accepted?</h3>
            <p>
