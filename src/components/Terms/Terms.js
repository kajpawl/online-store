    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-12 terms">
          ...
          <div className="termsSection">
            <h3>RISK OF LOSS</h3>
            <p>All items purchased from MYCOMPANY are made pursuant to a shipment contract. This basically means that the risk of loss and title for such items pass to you upon our delivery to the carrier.</p>
          </div>
          <div className="termsSection">
            <h3>PRODUCT DESCRIPTIONS</h3>
            <p>MYCOMPANY and its associates attempt to be as accurate as possible. However, MYCOMPANY does not warrant that product descriptions or other content of this site is accurate, complete, reliable, current, or error-free. If a product offered by MYCOMPANY itself is not as described, your sole remedy is to return it in unused condition. </p>
          </div>
          <div className="termsSection">
            <h3>APPLICABLE LAW</h3>
            <p>By visiting MYCOMPANY, you agree that the laws of the state of DEFINE_STATE, DEFINE_COUNTRY, without regard to principles of conflict of laws, will govern these Conditions of Use and any dispute of any sort that might arise between you and MYCOMPANY or its associates.</p>
          </div>
          <div className="termsSection">
            <h3>DISPUTES</h3>
          ...
          <div className="termsSection">
            <h3>QUESTIONS</h3>
            <p>Questions regarding our Conditions of Usage, Privacy Policy, or other policy related material can be directed to our support staff by clicking on the "Contact Us" link in the side menu. Or you can email us at: info@MYCOMPANY.com</p>
          </div>
        </div>
      </div>
    </div>
